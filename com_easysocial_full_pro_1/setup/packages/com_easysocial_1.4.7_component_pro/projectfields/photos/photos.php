...
class SocialFieldsProjectPhotos extends SocialFieldItem
{
    /**
     ...
     */
    public function onRegister(&$post, &$session, SocialTableProjectCategory $category)
    {
        // Check if they are allowed to create albums in this project's category
        $acl = $category->getAcl();
