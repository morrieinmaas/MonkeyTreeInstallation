...
class SocialFieldsProjectVideos extends SocialFieldItem
{
	/**
	 ...
	 *
	 */
	public function onEdit(&$data, &$project, $errors)
	{
		$params	= $project->getParams();
		$value = $project->getParams()->get('videos', $this->params->get('videos', $this->params->get('default', true)));
	 ...
	 *
	 */
	public function onEditBeforeSave(&$data, &$project)
	{
		// Get the posted value
		$value = $this->normalize($data, 'videos', $project->getParams()->get('videos', $this->params->get('default', true)));
		$value = (bool) $value;

		$project->params = $this->setParams($project, $value);
	}
	 ...
	 *
	 */
	public function onRegisterBeforeSave(&$data, &$project)
	{
	 ...
	 * @return	
	 */
	public function setParams($project, $value)
	{
		$params = $project->getParams();
