...
class SocialFieldsProjectTitle extends SocialFieldsUserTextbox
{
    /**
    ...
    public function getValue()
    {
        ...
        if ($this->field->type == SOCIAL_TYPE_PROJECT && !empty($this->field->uid)) {
            ...
            $container->value = $project->getName();

            $container->data = $project->title;
        }
    ...
    /**
     * Displays the project title textbox.
     *
     * @since   1.3
     * @access  public
    ...
    /**
     * Displays the project description textbox.
     *
     * @author  Jason Rey <jasonrey@stackideas.com>
     * @since   1.3
     * @access  public
    ...
    /**
     * Executes before the project is save.
     *
     * @author  Jason Rey <jasonrey@stackideas.com>
     * @since   1.3
     * @access  public
