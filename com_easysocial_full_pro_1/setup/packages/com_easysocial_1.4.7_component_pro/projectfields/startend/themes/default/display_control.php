...
?>
<div class="col-md-6 es-field-project-startend-box" data-startend-box>
    <div class="es-field-box">
        <div class="es-field-box-header">
            <i class="fa fa-calendar"></i> <?php echo JText::_('FIELDS_PROJECT_STARTEND_' . strtoupper($type) . '_DATETIME'); ?>
        </div>
        <p class="text-center es-field-project-startend-datetime" data-date data-date-utc="<?php echo $datetime->toSql(); ?>">
