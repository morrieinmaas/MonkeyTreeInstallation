...
EasySocial
.require()
.script('apps/fields/project/startend/content').done(function($) {
    $('[data-field-<?php echo $field->id; ?>]').addController('EasySocial.Controller.Field.Project.Startend', {
        ...
        dow: <?php echo $this->config->get('projects.startofweek', 0); ?>
    });
});
