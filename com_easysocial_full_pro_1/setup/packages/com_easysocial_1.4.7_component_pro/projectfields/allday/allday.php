...
class SocialFieldsProjectAllday extends SocialFieldsUserBoolean
{
    /**
    ...
    {
        $value = isset($post['project_allday']) ? $post['project_allday'] : $this->params->get('default');
    ...
    public function onEdit(&$post, &$cluster , $errors)
    {
        ...
        $value = isset($post['project_allday']) ? $post['project_allday'] : $cluster->isAllDay();
