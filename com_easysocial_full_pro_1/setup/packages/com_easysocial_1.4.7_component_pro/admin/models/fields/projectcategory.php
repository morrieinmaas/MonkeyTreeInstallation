...
class JFormFieldEasySocial_ProjectCategory extends JFormField
{
    protected $type = 'EasySocial_ProjectCategory';
    ...
    protected function getInput()
    {
        ...
        $output = $theme->output('admin/jfields/projectcategory');
