...
class JFormFieldEasySocial_Project extends JFormField
{
    protected $type = 'EasySocial_Project';
    ...
    protected function getInput()
    {
        ...
        $title = JText::_('COM_EASYSOCIAL_JFIELD_SELECT_PROJECT');
        ...
        $output = $theme->output('admin/jfields/project');
