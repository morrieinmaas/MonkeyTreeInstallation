...
class EasySocialModelProjectCategories extends EasySocialModel
{
    public function __construct($config = array())
    {
        parent::__construct('projectcategories', $config);
    }
    ...
    /**
     * Returns an array of SocialTableProjectCategory table object for backend listing.
     *
     * @author Jason Rey <jasonrey@stackideas.com>
     * @since  1.3
     * @access public
     * @return array    Array of SocialTableProjectCategory table objects.
     */
    public function getItems()
    {
        ...
        $categories = $this->bindTable('ProjectCategory', $result);

        return $categories;
    }

    /**
     * Returns an array of SocialTableProjectCategory table object for frontend listing.
     *
     * @author Jason Rey <jasonrey@stackideas.com>
     * @since  1.3
     * @access public
    ...
    /**
     * Returns an array of SocialTableProjectCategory table object based on profileId.
     *
     * @author Jason Rey <jasonrey@stackideas.com>
     * @since  1.3
     * @access public
    ...
    /**
     * Returns an array of SocialTableProjectGuest object based on category.
     *
     * @author Jason Rey <jasonrey@stackideas.com>
     * @since  1.3
     * @access public
     * @param  integer    $categoryId Category id to filter.
     * @return array                  Array of SocialTableProjectGuest object.
     */
    public function getRandomCategoryGuests($categoryId)
    {
        ...
        $sql->where('b.type', array(SOCIAL_PROJECT_TYPE_PUBLIC, SOCIAL_PROJECT_TYPE_PRIVATE), 'IN');
    ...
    public function getRandomCategoryAlbums($categoryId)
    {
        ...
        $sql->where('b.category_id', $categoryId);
        $sql->where('b.type', SOCIAL_PROJECT_TYPE_PUBLIC);
        $sql->order('', 'ASC', 'rand');
        $sql->limit(10);
    ...
    /**
     * Returns project creation stats in this category.
     *
     * @author Jason Rey <jasonrey@stackideas.com>
     * @since  1.3
     * @access public
    ...
    public function getCreationStats($categoryId)
    {
        ...
        foreach ($dates as &$row) {
            ...
            $query[] = "AND `type` = " . SOCIAL_PROJECT_TYPE_PUBLIC;
    ...
    public function updateProjectCategory($uid, $categoryId)
    {
