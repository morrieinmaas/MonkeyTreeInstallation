	...
	<div class="col-md-6">
		<div class="panel" data-start-widget>
			...
			<div class="panel-head">
				<ol>
					<li>
						<?php echo JText::_( 'COM_EASYSOCIAL_MIGRATOR_JOMSOCIAL_PROJECT_ITEM' );?>
					</li>
				</ol>
...
<div class="row">
	<div class="col-md-6">
		...
		<a href="<?php echo JRoute::_( 'index.php?option=com_easysocial&view=migrators&layout=jomsocialproject' ); ?>" style="display: none;" data-jomsocial-back-button >
			<?php echo JText::_( 'COM_EASYSOCIAL_MIGRATOR_BACK_TO_JOMSOCIAL_PROJECT_PAGE' );?>
		</a>
	</div>
</div>
