        ...
        <table class="app-table table table-eb table-striped">
            <thead>
                <tr>
                    ...
                    <th class="center" width="10%">
                        <?php echo JText::_('COM_EASYSOCIAL_TABLE_COLUMN_PROJECTS');?>
                    </th>
                    <?php } ?>
            ...
            <tbody>
                ...
                <?php if ($categories){ ?>
                    ...
                    <tr class="row<?php echo $i; ?>" data-grid-row data-id="<?php echo $category->id;?>">
                        ...
                        <td>
                            <a href="<?php echo FRoute::_('index.php?option=com_easysocial&view=projects&layout=categoryForm&id=' . $category->id);?>"
                        ...
                        <?php if (!$simple) { ?>
                        <td class="center">
                            <?php echo $this->html('grid.published', $category, 'projects', '', array('publishCategory', 'unpublishCategory')); ?>
                        </td>
                ...
                <?php } else { ?>
                    <tr class="is-empty">
                        <td colspan="<?php echo $simple ? '3' : '7'; ?>" class="center empty">
                            <?php echo JText::_('COM_EASYSOCIAL_PROJECT_CATEGORIES_NO_CATEGORIES_FOUND');?>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
