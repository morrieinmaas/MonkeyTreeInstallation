...
<dialog>
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_PROJECTS_DELETE_PROJECT_DIALOG_TITLE'); ?></title>
    <content>
        <p><?php echo JText::_('COM_EASYSOCIAL_PROJECTS_DELETE_PROJECT_DIALOG_CONFIRMATION'); ?></p>
    </content>
    <buttons>
