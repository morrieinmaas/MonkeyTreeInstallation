...
<dialog>
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_PROJECTS_CONFIRM_INVITE_GUEST_DIALOG_TITLE'); ?></title>
    <content>
        <form name="inviteGuests" method="post" action="index.php" data-form>
            <p><?php echo JText::_('COM_EASYSOCIAL_PROJECTS_CONFIRM_INVITE_GUEST_DIALOG_MESSAGE'); ?></p>
