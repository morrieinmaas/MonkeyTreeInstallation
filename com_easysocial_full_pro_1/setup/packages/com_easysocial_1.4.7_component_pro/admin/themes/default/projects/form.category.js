EasySocial.ready(function($) {
    ...
    $.Joomla('submitbutton', function(task) {
        if (task === 'cancel') {
            window.location = "<?php echo FRoute::url(array('view' => 'projects', 'layout' => 'categories')); ?>";
            return false;
        }
        ...
        if ($.isEmpty(title)) {
            EasySocial.dialog({
                content: '<?php echo JText::_('COM_EASYSOCIAL_PROJECTS_CATEGORY_TITLE_REQUIRED'); ?>',
                width: 400,
                height: 100
            });
        ...
        EasySocial.dialog({
            ...
            bindings: {
                '{deleteButton} click': function() {
                    EasySocial.ajax('admin/controllers/projects/removeCategoryAvatar', {
                        id: id
                    }).done(function() {
