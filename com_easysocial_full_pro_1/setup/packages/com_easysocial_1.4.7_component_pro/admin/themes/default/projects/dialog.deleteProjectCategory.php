...
<dialog>
    ...
    <title><?php echo JText::_('COM_EASYSOCIAL_PROJECT_CATEGORIES_DELETE_PROJECT_CATEGORY_DIALOG_TITLE'); ?></title>
    <content>
        <p><?php echo JText::_('COM_EASYSOCIAL_PROJECT_CATEGORIES_DELETE_PROJECT_CATEGORY_DIALOG_CONTENT'); ?></p>
    </content>
    <buttons>
