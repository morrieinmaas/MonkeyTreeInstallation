            ...
            <?php if (!empty($projects)) { ?>
                ...
                <?php foreach ($projects as $project) { ?>
                    <tr class="row<?php echo $i; ?>" data-grid-row data-id="<?php echo $project->id; ?>">
                        ...
                        <td>
                            <a href="<?php echo FRoute::url(array('view' => 'projects', 'layout' => 'form', 'id' => $project->id));?>"><?php echo JText::_($project->title); ?></a>
            ...
            <?php } else { ?>
                <tr class="is-empty">
                    <td colspan="8" class="center empty">
                        <?php echo JText::_( 'COM_EASYSOCIAL_PROJECTS_NO_PROJECT_FOUND' );?>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
