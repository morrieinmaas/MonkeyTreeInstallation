...
?>
<div id="fd" class="es mod-es-projects-categories module-project-categories<?php echo $suffix;?> es-responsive">
    ...
    <ul class="es-categories-list fd-reset-list">
        ...
        <li>
            ...
            <div class="es-category-object">
                ...
                <a href="<?php echo FRoute::projects(array('layout' => 'category' , 'id' => $category->getAlias()));?>" class="category-title"><?php echo $category->get('title');?></a>
            ...
            <div class="es-category-meta">
                <span class="hit-counter">
                    <i class="fa fa-users"></i> <?php echo JText::sprintf(FD::string()->computeNoun('MOD_EASYSOCIAL_PROJECTS_CATEGORY_PROJECTS_COUNT' , $category->getTotalProjects()) , $category->getTotalProjects()); ?>
                </span>
            </div>
            <?php } ?>
        </li>
