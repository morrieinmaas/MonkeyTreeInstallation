    ...
    <div style="padding-top: 10px">
        ...
        <div>
            ...
            <?php if ($event->start == $event->end) { ?>
                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_ON', ES::date($event->start)->toFormat('d-m-Y')); ?>
            <?php } else { ?>
                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_UPCOMING_REMINDER_FROM_TO', ES::date($event->start)->toFormat('d-m-Y'), ES::date($event->end)->toFormat('d-m-Y')); ?>
            <?php } ?>
            </span>
