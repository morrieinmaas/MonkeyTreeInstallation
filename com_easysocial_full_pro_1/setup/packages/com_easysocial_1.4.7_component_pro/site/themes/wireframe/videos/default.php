    ...
    <div class="es-content">
        <div class="es-video-listing es-video-item-group" data-videos-result>
            <?php if ($featuredVideos) { ?>
                <?php echo $this->output('site/videos/default.featured.items', array('featuredVideos' => $featuredVideos)); ?>
            <?php } ?>

            <?php echo $this->output('site/videos/default.items', array('videos' => $videos, 'pagination' => $pagination, 'filter' => $filter)); ?>
        </div>
    </div>
</div>
