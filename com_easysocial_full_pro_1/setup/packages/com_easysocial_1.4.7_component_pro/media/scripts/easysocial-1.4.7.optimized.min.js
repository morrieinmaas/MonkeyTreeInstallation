...
}}}),b.resolve()})}),EasySocial.module("admin/projects/approveRecurring",function(a){var b=this;
    EasySocial.Controller("Projects.ApproveRecurring",{defaultOptions:{postdatas:{},schedules:{},projectids:[],"{progress}":"[data-progress-bar]","{form}":"[data-form]"}},function(b){return{init:function(){var c=0;a.each(b.options.schedules,function(a,b){c+=b.length}),b.total=c,b.startCreate()},total:0,doneCounter:0,projectCounter:0,createCounter:0,updateProgressBar:function(){var a=Math.ceil(b.doneCounter/b.total*100);b.progress().css({width:a+"%"})},startCreate:function(){return void 0===b.options.projectids[b.projectCounter]?b.completed():(b.create().done(function(){b.doneCounter++,b.createCounter++,void 0===b.options.schedules[b.options.projectids[b.projectCounter]][b.createCounter]&&(b.projectCounter++,b.createCounter=0),b.updateProgressBar(),b.startCreate()
    }).fail(function(a,b){console.log(a,b)}),void 0)},create:function(){var a=b.options.projectids[b.projectCounter],c=b.options.schedules[a][b.createCounter],d=b.options.postdatas[a];return EasySocial.ajax("admin/controllers/projects/createRecurring",{projectId:a,datetime:c,postdata:d})},completed:function(){b.progress().parent().removeClass("progress-info").addClass("progress-success"),b.form().submit()}}}),b.resolve()}),EasySocial.module("admin/projects/store",function(a){var b=this;EasySocial.Controller("Projects.Update",{defaultOptions:{postdata:{},updateids:[],schedule:[],projectId:null,"{progress}":"[data-progress-bar]","{form}":"[data-form]"}},function(b){return{init:function(){b.startUpdate()
},updateCounter:0,createCounter:0,updateProgressBar:function(){var a=Math.ceil((b.updateCounter+b.createCounter)/(b.options.updateids.length+b.options.schedule.length)*100);b.progress().css({width:a+"%"})},startUpdate:function(){return void 0===b.options.updateids[b.updateCounter]?b.startCreate():(b.update(b.options.updateids[b.updateCounter]).done(function(){b.updateCounter++,b.updateProgressBar(),b.startUpdate()}).fail(function(a,b){console.log(a,b)}),void 0)},update:function(c){var d=a.extend({},b.options.postdata,{id:c,applyRecurring:1});
    return EasySocial.ajax("admin/controllers/projects/store",d)},startCreate:function(){return void 0===b.options.schedule[b.createCounter]?b.completed():(b.create(b.options.schedule[b.createCounter]).done(function(){b.createCounter++,b.updateProgressBar(),b.startCreate()}).fail(function(a,b){console.log(a,b)}),void 0)},create:function(a){return EasySocial.ajax("admin/controllers/projects/createRecurring",{projectId:b.options.projectId,datetime:a,postdata:b.options.postdata})},completed:function(){b.progress().parent().removeClass("progress-info").addClass("progress-success"),b.form().submit()
}}}),b.resolve()}),EasySocial.module("admin/projects/users",function(){var b=this;EasySocial.require().language("JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST").done(function(a){EasySocial.Controller("Projects.Users",{defaultOptions:{projectid:null,"{inviteGuest}":"[data-project-invite-guest]","{removeGuest}":"[data-project-remove-guest]","{approveGuest}":"[data-project-approve-guest]","{promoteGuest}":"[data-project-promote-guest]","{demoteGuest}":"[data-project-demote-guest]"}},function(b){return{init:function(){},"{inviteGuest} click":function(){var d={};
    window.inviteGuests=function(a){a.state?d[a.id]=a:delete d[a.id]};var e=function(){EasySocial.dialog({content:EasySocial.ajax("admin/views/projects/confirmInviteGuests",{guests:d,projectid:b.options.projectid}),bindings:{"{submitButton} click":function(){this.inviteGuestsForm().submit()}}})};EasySocial.dialog({content:EasySocial.ajax("admin/views/projects/inviteGuests"),bindings:{"{submitButton} click":function(){e()}}})},"{removeGuest} click":function(){0==document.adminForm.boxchecked.value?alert(a.language("JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST")):a.Joomla("submitform",["removeGuests"])
},"{approveGuest} click":function(){0==document.adminForm.boxchecked.value?alert(a.language("JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST")):a.Joomla("submitform",["approveGuests"])},"{promoteGuest} click":function(){0==document.adminForm.boxchecked.value?alert(a.language("JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST")):a.Joomla("submitform",["promoteGuests"])},"{demoteGuest} click":function(){0==document.adminForm.boxchecked.value?alert(a.language("JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST")):a.Joomla("submitform",["demoteGuests"])
...
})},"{reset} click":function(){b.setTimezone(b.parent.options.timezone)},"{local} click":function(){b.setTimezone("local")},setTimezone:function(a){b.timezones().val(a).trigger("liszt:updated").trigger("change")}}}),b.resolve()})}),EasySocial.module("apps/project/discussions",function(){var b=this;EasySocial.Controller("Projects.Item.Discussions",{defaultOptions:{"{filter}":"[data-project-discussions-filter]","{contents}":"[data-project-discussion-contents]"}},function(a){return{init:function(){a.options.id=a.element.data("id")},setContent:function(b){a.contents().removeClass("is-loading"),a.contents().html(b)},setActiveFilter:function(b){a.filter().removeClass("active"),b.addClass("active")},"{filter} click":function(b){var d=b.data("filter");
    a.contents().html("&nbsp;").addClass("is-loading"),a.setActiveFilter(b),EasySocial.ajax("apps/project/discussions/controllers/discussion/getDiscussions",{id:a.options.id,filter:d}).done(function(b,c){c?a.contents().addClass("is-empty"):a.contents().removeClass("is-empty"),a.setContent(b)})}}}),EasySocial.Controller("Projects.Item.Discussion",{defaultOptions:{"{form}":"[data-reply-form]","{list}":"[data-reply-list]","{replies}":"[data-reply-item]","{repliesWrap}":"[data-replies-wrapper]","{replyCounter}":"[data-reply-count]","{lock}":"[data-discussion-lock]","{unlock}":"[data-discussion-unlock]","{delete}":"[data-discussion-delete]"}},function(a){return{init:function(){a.options.id=a.element.data("id"),a.options.projectId=a.element.data("projectid"),a.implementReply(a.replies()),a.form().implement(EasySocial.Controller.Projects.Item.Discussion.Form,{"{parent}":a})
},implementReply:function(){a.replies().implement(EasySocial.Controller.Projects.Item.Discussion.Reply,{"{parent}":a})},insertReply:function(b){a.element.removeClass("is-unanswered"),a.repliesWrap().removeClass("is-empty"),a.list().append(b),a.implementReply()},updateReplyCounter:function(b){0==b&&a.repliesWrap().addClass("is-empty"),a.replyCounter().html(b)},setResolved:function(){a.element.addClass("is-resolved")},"{unlock} click":function(){EasySocial.ajax("apps/project/discussions/controllers/discussion/unlock",{id:a.options.id}).done(function(){a.element.removeClass("is-locked")
})},"{delete} click":function(){EasySocial.dialog({content:EasySocial.ajax("apps/project/discussions/controllers/discussion/confirmDelete",{id:a.options.id,projectId:a.options.projectId})})},"{lock} click":function(){EasySocial.dialog({content:EasySocial.ajax("apps/project/discussions/controllers/discussion/confirmLock"),bindings:{"{lockButton} click":function(){EasySocial.ajax("apps/project/discussions/controllers/discussion/lock",{id:a.options.id}).done(function(){EasySocial.dialog().close(),a.element.addClass("is-locked")
})}}})}}}),EasySocial.Controller("Projects.Item.Discussion.Reply",{defaultOptions:{"{acceptAnswer}":"[data-reply-accept-answer]","{delete}":"[data-reply-delete]","{edit}":"[data-reply-edit]","{cancelEdit}":"[data-reply-edit-cancel]","{update}":"[data-reply-edit-update]","{textarea}":"[data-reply-content]","{content}":"[data-reply-display-content]","{alertDiv}":"div.alert-error"}},function(a){return{init:function(){console.log(a.element),a.options.id=a.element.data("id")},"{acceptAnswer} click":function(){EasySocial.ajax("apps/project/discussions/controllers/reply/accept",{id:a.options.id}).done(function(){a.parent.setResolved()
})},cancelEditing:function(){a.element.removeClass("is-editing")},"{cancelEdit} click":function(){a.cancelEditing()},"{edit} click":function(){a.element.addClass("is-editing")},"{update} click":function(){var b=a.textarea().val();return""==b?(a.element.addClass("is-empty"),a.alertDiv().show(),!1):(EasySocial.ajax("apps/project/discussions/controllers/reply/update",{id:a.options.id,projectId:a.parent.options.projectId,content:b}).done(function(b){a.content().html(b),a.element.removeClass("is-empty"),a.alertDiv().hide(),a.cancelEditing()
}),void 0)},"{delete} click":function(){EasySocial.dialog({content:EasySocial.ajax("apps/project/discussions/controllers/reply/confirmDelete",{id:a.options.id}),bindings:{"{deleteButton} click":function(){EasySocial.ajax("apps/project/discussions/controllers/reply/delete",{id:a.options.id}).done(function(b){a.parent.updateReplyCounter(b.total_replies),EasySocial.dialog().close(),a.element.remove()})}}})}}}),EasySocial.Controller("Projects.Item.Discussion.Form",{defaultOptions:{"{textarea}":"[data-reply-content]","{submitReply}":"[data-reply-submit]"}},function(a){return{init:function(){},"{submitReply} click":function(){var d=a.textarea().val();
    return""==d?(a.element.addClass("is-empty"),!1):(EasySocial.ajax("apps/project/discussions/controllers/reply/submit",{id:a.parent.options.id,projectId:a.parent.options.projectId,content:d}).done(function(b){a.parent.insertReply(b),a.textarea().val("")}),void 0)}}}),b.resolve()}),EasySocial.module("apps/project/guests",function(){var b=this;EasySocial.Controller("Projects.Item.Guests",{defaultOptions:{"{filters}":"[data-project-guests-filter]","{content}":"[data-project-guests-content]"}},function(a){return{init:function(){a.options.id=a.element.data("id"),a.items=a.addPlugin("Item")
},"{filters} click":function(b,c){c.preventDefault(),b.route(),a.filters().removeClass("active"),b.addClass("active");var d=b.data("filter");a.content().html("&nbsp;"),a.content().addClass("is-loading"),EasySocial.ajax("apps/project/guests/controllers/projects/filterGuests",{id:a.options.id,filter:d}).done(function(b,c){a.content().removeClass("is-loading"),0==c?a.content().addClass("is-empty"):a.content().removeClass("is-empty"),a.content().html(b)})},"{self} emptyGuest":function(){a.content().addClass("is-empty")
}}}),EasySocial.Controller("Projects.Item.Guests.Item",{defaultOptions:{"{item}":"[data-project-guest-item]","{promote}":"[data-guest-promote]","{demote}":"[data-guest-demote]","{approve}":"[data-guest-approve]","{reject}":"[data-guest-reject]","{remove}":"[data-guest-remove]"}},function(a){return{init:function(){},getItem:function(b){var c=a.item.of(b);return c},"{approve} click":function(b){var c=a.getItem(b),d=c.data("guestId");EasySocial.dialog({content:EasySocial.ajax("site/views/projects/confirmApproveGuest",{id:d}),bindings:{"{approveButton} click":function(){EasySocial.ajax("site/controllers/projects/approveGuest",{id:d}).done(function(){EasySocial.dialog().close(),c.remove(),0===a.item().length&&a.element.trigger("emptyGuest")
})}}})},"{reject} click":function(b){var c=a.getItem(b),d=c.data("guestId");EasySocial.dialog({content:EasySocial.ajax("site/views/projects/confirmRejectGuest",{id:d}),bindings:{"{rejectButton} click":function(){EasySocial.ajax("site/controllers/projects/rejectGuest",{id:d}).done(function(){EasySocial.dialog().close(),c.remove(),0===a.item().length&&a.element.trigger("emptyGuest")})}}})},"{promote} click":function(b){var c=a.getItem(b),d=c.data("guestId");EasySocial.dialog({content:EasySocial.ajax("site/views/projects/confirmPromoteGuest",{id:d}),bindings:{"{promoteButton} click":function(){EasySocial.ajax("site/controllers/projects/promoteGuest",{id:d}).done(function(){EasySocial.dialog().close(),c.removeClass("is-member").addClass("is-admin")
})}}})},"{demote} click":function(b){var c=a.getItem(b),d=c.data("guestId");EasySocial.dialog({content:EasySocial.ajax("site/views/projects/confirmDemoteGuest",{id:d}),bindings:{"{demoteButton} click":function(){EasySocial.ajax("site/controllers/projects/demoteGuest",{id:d}).done(function(){EasySocial.dialog().close(),"admin"==a.parent.filters(".active").data("filter")?(c.remove(),0===a.item().length&&a.element.trigger("emptyGuest")):c.removeClass("is-admin").addClass("is-member")})}}})},"{remove} click":function(b){var d=a.getItem(b),e=d.data("guestId");
    EasySocial.dialog({content:EasySocial.ajax("site/views/projects/confirmRemoveGuest",{id:e}),bindings:{"{removeButton} click":function(){EasySocial.ajax("site/controllers.projects/removeGuest",{id:e}).done(function(){EasySocial.dialog().close(),d.remove(),0===a.item().length&&a.element.trigger("emptyGuest")})}}})}}}),b.resolve()}),EasySocial.module("apps/project/tasks",function(a){var b=this;EasySocial.Controller("Projects.Apps.Tasks.Milestones.Browse",{defaultOptions:{projectId:null,"{milestone}":"[data-tasks-milestone-item]"}},function(a){return{init:function(){a.options.projectId=a.element.data("projectid"),a.milestone().addController(EasySocial.Controller.Projects.Apps.Tasks.Milestones.Item,{"{parent}":a})
}}}),EasySocial.Controller("Projects.Apps.Tasks.Milestones.Item",{defaultOptions:{"{complete}":"[data-milestone-mark-complete]","{incomplete}":"[data-milestone-mark-incomplete]","{delete}":"[data-milestone-delete]","{milestone}":"[data-project-tasks-milestone-item]"}},function(a){return{init:function(){a.options.id=a.element.data("id")},"{incomplete} click":function(b){EasySocial.ajax("apps/project/tasks/controllers/milestone/unresolve",{id:a.options.id,projectId:a.parent.options.projectId}).done(function(){a.element.removeClass("is-due").removeClass("is-completed"),b.hide(),a.complete().show()
})},"{complete} click":function(b){EasySocial.ajax("apps/project/tasks/controllers/milestone/resolve",{id:a.options.id,projectId:a.parent.options.projectId}).done(function(){a.element.removeClass("is-due").addClass("is-completed"),b.hide(),a.incomplete().show()})},"{delete} click":function(){EasySocial.dialog({content:EasySocial.ajax("apps/project/tasks/controllers/milestone/confirmDelete",{id:a.options.id,projectId:a.parent.options.projectId}),bindings:{"{deleteButton} click":function(){EasySocial.ajax("apps/project/tasks/controllers/milestone/delete",{id:a.options.id,projectId:a.parent.options.projectId}).done(function(){EasySocial.dialog().close(),a.element.remove()
})}}})}}}),EasySocial.Controller("Projects.Apps.Tasks",{defaultOptions:{"{form}":"[data-tasks-form]","{formWrapper}":"[data-tasks-form-wrapper]","{taskList}":"[data-tasks-list]","{item}":"[data-tasks-list-item]","{completedList}":"[data-tasks-completed]","{openCounter}":"[data-tasks-open-counter]","{closedCounter}":"[data-tasks-closed-counter]","{completeMilestone}":"[data-milestone-mark-complete]","{incompleteMilestone}":"[data-milestone-mark-incomplete]","{deleteMilestone}":"[data-milestone-delete]","{wrapper}":"[data-tasks-wrapper]"}},function(b){return{init:function(){b.options.id=b.element.data("id"),b.options.projectId=b.element.data("projectid"),b.options.milestoneId=b.element.data("milestoneid"),b.form().addController(EasySocial.Controller.Projects.Apps.Tasks.Form,{"{parent}":b}),b.implementItemController()
},implementItemController:function(){b.item().addController(EasySocial.Controller.Projects.Apps.Tasks.Item,{"{parent}":b})},updateOpenCounter:function(a){b.openCounter().html(a)},updateClosedCounter:function(a){b.closedCounter().html(a)},insertCompleted:function(c){a(c).appendTo(b.completedList())},insertTask:function(a){b.formWrapper().after(a),b.implementItemController()},"{uncompleteMilestone} click":function(){EasySocial.ajax("apps/project/tasks/controllers/milestone/unresolve",{id:b.options.milestoneId,projectId:b.options.projectId}).done(function(){b.wrapper().removeClass("is-due").removeClass("is-completed")
})},"{completeMilestone} click":function(){EasySocial.ajax("apps/project/tasks/controllers/milestone/resolve",{id:b.options.milestoneId,projectId:b.options.projectId}).done(function(){b.wrapper().removeClass("is-due").addClass("is-completed")})},"{deleteMilestone} click":function(){EasySocial.dialog({content:EasySocial.ajax("apps/project/tasks/controllers/milestone/confirmDelete",{id:b.options.milestoneId,projectId:b.options.projectId}),bindings:{"{deleteButton} click":function(){EasySocial.ajax("apps/project/tasks/controllers/milestone/delete",{id:b.options.id,projectId:b.options.projectId}).done(function(){EasySocial.dialog().close(),window.location=b.options.redirect
})}}})}}}),EasySocial.Controller("Projects.Apps.Tasks.Item",{defaultOptions:{"{checkbox}":"[data-item-checkbox]","{delete}":"[data-tasks-item-remove]"}},function(b){return{init:function(){b.options.id=b.element.data("id")},"{delete} click":function(){EasySocial.dialog({content:EasySocial.ajax("apps/project/tasks/controllers/tasks/confirmDelete",{projectId:b.parent.options.projectId}),bindings:{"{deleteButton} click":function(){EasySocial.ajax("apps/project/tasks/controllers/tasks/delete",{id:b.options.id,projectId:b.parent.options.projectId}).done(function(){EasySocial.dialog().close();
    var a=parseInt(b.parent.openCounter().html());b.parent.updateOpenCounter(a-1),b.element.remove()})}}})},"{checkbox} change":function(c){var e=a(c).is(":checked");e?EasySocial.ajax("apps/project/tasks/controllers/tasks/resolve",{id:b.options.id,projectId:b.parent.options.projectId}).done(function(){var a=parseInt(b.parent.openCounter().html());b.parent.updateOpenCounter(a-1);var a=parseInt(b.parent.closedCounter().html());b.parent.updateClosedCounter(a+1),b.parent.insertCompleted(b.element)}):EasySocial.ajax("apps/project/tasks/controllers/tasks/unresolve",{id:b.options.id,projectId:b.parent.options.projectId}).done(function(){var c=parseInt(b.parent.openCounter().html());
    b.parent.updateOpenCounter(c+1);var c=parseInt(b.parent.closedCounter().html());b.parent.updateClosedCounter(c-1),b.parent.insertTask(b.element)})}}}),EasySocial.Controller("Projects.Apps.Tasks.Form",{defaultOptions:{"{title}":"[data-form-tasks-title]","{create}":"[data-form-tasks-create]","{assignee}":"[data-form-tasks-assignee]","{due}":"[data-form-tasks-due]","{error}":"[data-tasks-form-error]"}},function(a){return{init:function(){},resetForm:function(){a.element[0].reset()},"{title} keyup":function(b,c){13==c.keyCode&&a.create().click()
},"{create} click":function(){return""==a.title().val()?(a.error().removeClass("hide"),!1):(a.error().addClass("hide"),EasySocial.ajax("apps/project/tasks/controllers/tasks/save",{title:a.title().val(),assignee:a.assignee().val(),due:a.due().val(),projectId:a.parent.options.projectId,milestoneId:a.parent.options.milestoneId}).done(function(b){a.resetForm();var c=parseInt(a.parent.openCounter().html());a.parent.updateOpenCounter(c+1),a.parent.insertTask(b)}),void 0)}}}),b.resolve()}),EasySocial.module("apps/fields/project/permalink/content",function(){var b=this;
    EasySocial.require().language("FIELDS_PROJECT_PERMALINK_EXCEEDED_MAX_LENGTH","FIELDS_PROJECT_PERMALINK_REQUIRED").done(function(a){EasySocial.Controller("Field.Project.Permalink",{defaultOptions:{required:!1,max:0,id:null,clusterid:null,userid:null,"{field}":"[data-field-permalink]","{checkButton}":"[data-permalink-check]","{input}":"[data-permalink-input]","{available}":"[data-permalink-available]"}},function(b){return{state:!1,init:function(){b.options.max=b.field().data("max")},"{checkButton} click":function(){b.delayedCheck()
    },"{input} keyup":function(){b.delayedCheck()},delayedCheck:a.debounce(function(){b.checkPermalink()},250),checkPermalink:function(){b.clearError();var c=b.input().val();if(b.available().hide(),b.options.max>0&&c.length>b.options.max)return b.raiseError(a.language("FIELDS_PROJECT_PERMALINK_EXCEEDED_MAX_LENGTH")),!1;if(!a.isEmpty(c)){b.checkButton().addClass("btn-loading");var d=a.Deferred();return EasySocial.ajax("fields/project/permalink/isValid",{id:b.options.id,clusterid:b.options.clusterid,permalink:c}).done(function(){b.clearError(),b.checkButton().removeClass("btn-loading"),b.available().show(),d.resolve()
    }).fail(function(a){b.raiseError(a),b.checkButton().removeClass("btn-loading"),b.available().hide(),d.reject()}),d}return b.options.required&&a.isEmpty(c)?(b.available().hide(),b.raiseError(a.language("FIELDS_PROJECT_PERMALINK_REQUIRED")),!1):!0},raiseError:function(a){b.trigger("error",[a])},clearError:function(){b.trigger("clear")},"{self} onSubmit":function(a,c,d){d.push(b.checkPermalink())}}}),b.resolve()})}),EasySocial.module("apps/fields/project/permalink/sample_content",function(){var b=this;EasySocial.Controller("Field.Permalink.Sample",{defaultOptions:{"{checkPermalink}":"[data-check-permalink]"}},function(a){return{init:function(){},"{self} onConfigChange":function(b,c,d,e){switch(d){case"check_permalink":a.checkPermalink().toggle(!!e)
}}}}),b.resolve()}),EasySocial.module("apps/fields/project/recurring/content",function(a){var b=this;EasySocial.require().library("datetimepicker").done(function(){EasySocial.Controller("Field.Project.Recurring",{defaultOptions:{id:null,value:{},allday:0,showWarningMessages:0,projectId:null,"{type}":"[data-recurring-type]","{endBlock}":"[data-recurring-end-block]","{picker}":"[data-recurring-end-picker]","{toggle}":"[data-recurring-end-toggle]","{result}":"[data-recurring-end-result]","{dailyBlock}":"[data-recurring-daily-block]","{dailyInput}":"[data-recurring-daily-block] input","{summaryBlock}":"[data-recurring-summary-block]","{scheduleToggle}":"[data-recurring-schedule-toggle]","{scheduleBlock}":"[data-recurring-schedule-block]","{scheduleLoadingBlock}":"[data-recurring-schedule-loading-block]","{deleteRecurringButton}":"[data-recurring-delete]"}},function(b){return{init:function(){b.picker()._datetimepicker({pickTime:!1,component:"es",useCurrent:!1});
    var c=b.result().val();if(!a.isEmpty(c)){var d=a.moment(c);b.datetimepicker("setDate",d)}b.calculateTotalRecur()},changed:0,"{window} easysocial.fields.allday.change":function(a,c,d){b.options.allday=d,b.calculateTotalRecur()},"{window} easysocial.fields.startend.start.change":function(){b.calculateTotalRecur()},"{toggle} click":function(){b.picker().focus()},"{picker} dp.change":function(a,c){b.setDateValue(c.date.toDate()),b.detectChanges(),b.calculateTotalRecur()},"{type} change":function(a){var d=a.val();
    b.endBlock()["none"===d?"hide":"show"](),b.dailyBlock()["daily"===d?"show":"hide"](),b.detectChanges(),b.calculateTotalRecur()},"{dailyInput} change":function(){b.detectChanges(),b.calculateTotalRecur()},calculateTotalRecur:function(){b.summaryBlock().hide(),b.clearError();var c=a("[data-project-start]").find("[data-datetime]").val(),d=a("[data-project-timezone]").val(),e=b.result().val(),f=b.type().val(),g=[];("none"!=f||b.options.showWarningMessages)&&(a.isEmpty(c)||a.isEmpty(e)||a.isEmpty(f)||(a.each(b.dailyBlock().find("input"),function(b,c){el=a(c),el.is(":checked")&&g.push(el.val())
}),b.scheduleLoadingBlock().show(),b.getTotalRecur({start:c,timezone:d,end:e,type:f,daily:g})))},getTotalRecur:a.debounce(function(a){b.clearError(),EasySocial.ajax("fields/project/recurring/calculateTotalRecur",{id:b.options.id,start:a.start,timezone:a.timezone,allday:b.options.allday,end:a.end,type:a.type,daily:a.daily,projectId:b.options.projectId,changed:b.changed,showWarningMessages:b.options.showWarningMessages}).done(function(a){b.summaryBlock().html(a).show()}).fail(function(a){b.raiseError(a)}).always(function(){b.scheduleLoadingBlock().hide()
})},500),detectChanges:function(){var c=b.result().val(),d=b.type().val(),e=[],f=!1;a.each(b.dailyBlock().find("input"),function(b,c){el=a(c),el.is(":checked")&&e.push(el.val())}),(d!=b.options.value.type||c!=b.options.value.end||e.length!=b.options.value.daily.length)&&(f=!0),a.each(e,function(c,d){return-1==a.inArray(d,b.options.value.daily)?(f=!0,!1):void 0}),a.each(b.options.value.daily,function(b,c){return-1==a.inArray(c,e)?(f=!0,!1):void 0}),b.changed=f?1:0,a(window).trigger("easysocial.fields.recurring.changed",[f])
},"{scheduleToggle} click":function(){b.scheduleBlock().toggle()},"{deleteRecurringButton} click":function(){EasySocial.dialog({content:EasySocial.ajax("site/views/projects/deleteRecurringDialog",{id:b.options.projectId}),bindings:{"{submitButton} click":function(){var a=this.parent;a.loading(!0),b.deleteRecurring().done(function(){a.loading(!1),a.close(),b.calculateTotalRecur()})}}})},deleteRecurring:function(){return EasySocial.ajax("site/controllers/projects/deleteRecurring",{projectId:b.options.projectId})},datetimepicker:function(a,c){return b.picker().data("DateTimePicker")[a](c)
},setDateValue:function(a){b.result().val(a.getFullYear()+"-"+("00"+(a.getMonth()+1)).slice(-2)+"-"+("00"+a.getDate()).slice(-2)+" "+("00"+a.getHours()).slice(-2)+":"+("00"+a.getMinutes()).slice(-2)+":"+("00"+a.getSeconds()).slice(-2))},"{self} onSubmit":function(a,b,c){c.push(!0)},raiseError:function(a){b.trigger("error",[a])},clearError:function(){b.trigger("clear")}}}),b.resolve()})}),EasySocial.module("apps/fields/project/startend/content",function(){var b=this,c=EasySocial.options.momentLang;EasySocial.require().library("datetimepicker","moment/"+c).language("FIELDS_PROJECT_STARTEND_VALIDATION_DATETIME_START_REQUIRED","FIELDS_PROJECT_STARTEND_VALIDATION_DATETIME_END_REQUIRED").done(function(a){EasySocial.Controller("Field.Project.Startend",{defaultOptions:{dateFormat:"",allowTime:!0,allowTimezone:!0,disallowPast:!1,minuteStepping:15,yearfrom:"",yearto:"",requiredEnd:!1,allday:!1,calendarLanguage:"english",dow:0,"{startForm}":"[data-project-start]","{endForm}":"[data-project-end]","{timezone}":"[data-project-timezone]"}},function(b){return{init:function(){b.options.yearto=a.isEmpty(b.options.yearto)?(new Date).getFullYear()+100:parseInt(b.options.yearto)+1,b.options.yearfrom=b.options.yearfrom||1930,b.startDatetime=b.startForm().addController("EasySocial.Controller.Field.Project.Startend.Form",{"{parent}":b,type:"start"}),b.endDatetime=b.endForm().addController("EasySocial.Controller.Field.Project.Startend.Form",{"{parent}":b,type:"end"})
},"{self} onSubmit":function(a,c,d){d.push(b.validateInput())},validateInput:function(){return b.clearError(),a.isEmpty(b.startDatetime.datetime().val())?(b.raiseError(a.language("FIELDS_PROJECT_STARTEND_VALIDATION_DATETIME_START_REQUIRED")),!1):b.options.requireEnd&&a.isEmpty(b.endDatetime.datetime().val())?(b.raiseError(a.language("FIELDS_PROJECT_STARTEND_VALIDATION_DATETIME_END_REQUIRED")),!1):!0},raiseError:function(a){b.trigger("error",[a])},clearError:function(){b.trigger("clear")}}}),EasySocial.Controller("Field.Project.Startend.Form",{defaultOptions:{type:null,"{picker}":"[data-picker]","{toggle}":"[data-picker-toggle]","{datetime}":"[data-datetime]"}},function(b,d){return{init:function(){b.load()
},"{window} easysocial.fields.startend.start.change":function(){"start"==d.type&&b.parent.endDatetime&&(b.parent.endDatetime.datetimepicker("destroy"),b.parent.endDatetime.load())},"{window} easysocial.fields.allday.change":function(a,c,d){b.datetimepicker("destroy"),b.parent.options.allday=1==d?!0:!1,b.load()},load:function(){var e=new a.moment;if(b.parent.options.disallowPast?e.date(e.date()-1):e.year(b.parent.options.yearfrom),"end"==d.type){var f=b.parent.startDatetime.datetime().val();if(f)var e=a.moment(f),e=e.date(e.date()-1)
}var g=b.parent.options.allowTime&&!b.parent.options.allday,h=b.parent.options.dateFormat;g||(h=h.substr(0,10)),b.picker()._datetimepicker({component:"es",useCurrent:!1,format:h,minDate:e,maxDate:new a.moment({y:b.parent.options.yearto}),icons:{time:"glyphicon glyphicon-time",date:"glyphicon glyphicon-calendar",up:"glyphicon glyphicon-chevron-up",down:"glyphicon glyphicon-chevron-down"},sideBySide:!1,pickTime:g,minuteStepping:parseInt(b.parent.options.minuteStepping),language:"english"==b.parent.options.calendarLanguage?"en-gb":c,dow:b.parent.options.dow});
    var i=b.datetime().val();if(!a.isEmpty(i)){var j=a.moment(i);b.datetimepicker("setDate",j)}},datetimepicker:function(a,c){return b.picker().data("DateTimePicker")[a](c)},"{toggle} click":function(){b.picker().focus()},"{picker} dp.change":function(c,e){b.setDateValue(e.date.toDate()),a(window).trigger("easysocial.fields.startend."+d.type+".change",[e.date])},"{picker} change":function(c){a.isEmpty(c.val())&&b.datetime().val("")},setDateValue:function(a){b.datetime().val(a.getFullYear()+"-"+("00"+(a.getMonth()+1)).slice(-2)+"-"+("00"+a.getDate()).slice(-2)+" "+("00"+a.getHours()).slice(-2)+":"+("00"+a.getMinutes()).slice(-2)+":"+("00"+a.getSeconds()).slice(-2))
}}}),b.resolve()})}),EasySocial.module("apps/fields/project/startend/display",function(){var b=this;EasySocial.require().library("chosen","popbox").language("FIELDS_USER_DATETIME_LOCAL_TIMEZONE","FIELDS_USER_DATETIME_TIMEZONE_CHECKING").done(function(a){EasySocial.Controller("Field.Project.Startend.Display",{defaultOptions:{id:null,userid:null,"{box}":"[data-startend-box]"}},function(a){return{init:function(){a.box().addController("EasySocial.Controller.Field.Project.Startend.Display.Box",{"{parent}":a})}}}),EasySocial.Controller("Field.Project.Startend.Display.Box",{defaultOptions:{date:null,timezone:null,local:null,"{toggle}":"[data-popbox]","{content}":"[data-popbox-content]","{date}":"[data-date]","{timezone}":"[data-timezone]","{loading}":"[data-loading]"}},function(b){return{init:function(){b.options.timezone=b.timezone().data("timezone"),b.options.date=b.date().data("date-utc"),b.options.local=-(new Date).getTimezoneOffset()/60;
    var a=b.content().html(),c=b.toggle().data("popbox-position");b.toggle().popbox({content:a,id:"fd",component:"es",type:"timezone",toggle:"click",position:c}).attr("data-popbox","")},"{toggle} popboxActivate":function(a,c,d){d.tooltip.addController("EasySocial.Controller.Field.Project.Startend.Display.Timezone",{"{parent}":b})},datetime:a.memoize(function(a){return EasySocial.ajax("fields/project/startend/getDatetime",{id:b.parent.options.id,userid:b.parent.options.userid,tz:a,local:b.options.local,datetime:b.options.date})
})}}),EasySocial.Controller("Field.Project.Startend.Display.Timezone",{defaultOptions:{"{timezones}":"[data-timezone-select]","{reset}":"[data-timezone-reset]","{local}":"[data-timezone-local]"}},function(b){return{init:function(){b.timezones().chosen({search_contains:!0})},"{timezones} change":function(c){var e=c.val();b.parent.date().html(a.language("FIELDS_USER_DATETIME_TIMEZONE_CHECKING")),b.parent.timezone().html("local"===e?a.language("FIELDS_USER_DATETIME_LOCAL_TIMEZONE"):e),b.parent.datetime(e).done(function(a){b.parent.date().html(a)
...
}).fail(function(a){return a}).always(function(){b.element.removeClass("loading")}),void 0)}}}),b.resolve()})}),EasySocial.module("site/dashboard/dashboard",function(){var b=this;EasySocial.require().script("site/dashboard/apps","site/dashboard/feeds","site/dashboard/sidebar","site/stream/filter","site/dashboard/groups","site/dashboard/events","site/dashboard/projects").done(function(a){EasySocial.Controller("Dashboard",{defaultOptions:{currentTitle:null,pageTitle:null,"{heading}":"[data-dashboard-heading]","{sidebar}":"[data-dashboard-sidebar]","{content}":"[data-dashboard-real-content]","{feeds}":"[data-dashboard-feeds]","{groups}":"[data-dashboard-groups]","{events}":"[data-dashboard-events]","{projects}":"[data-dashboard-projects]","{groupItems}":"[data-dashboard-group-item]","{eventItems}":"[data-dashboard-event-item]","{projectItems}":"[data-dashboard-project-item]","{showAllFilters}":"[data-app-filters-showall]","{showAllGroups}":"[data-groups-filters-showall]","{showAllEvents}":"[data-events-filters-showall]","{showAllProjects}":"[data-projects-filters-showall]","{appFilters}":"[data-sidebar-app-filter]","{apps}":"[data-dashboard-apps]","{saveHashTag}":"[data-hashtag-filter-save]"}},function(b){return{init:function(){b.sidebar().implement(EasySocial.Controller.Dashboard.Sidebar,{"{parent}":b}),b.feedsController=b.feeds().addController(EasySocial.Controller.Dashboard.Feeds,{"{parent}":b}),b.apps().implement(EasySocial.Controller.Dashboard.Apps,{"{parent}":b,pageTitle:b.options.pageTitle}),b.groups().implement(EasySocial.Controller.Dashboard.Groups,{"{parent}":b}),b.events().implement(EasySocial.Controller.Dashboard.Events,{"{parent}":b}),b.projects().implement(EasySocial.Controller.Dashboard.Projects,{"{parent}":b})
},"{showAllGroups} click":function(c){a(c).hide(),b.groupItems().removeClass("hide")},"{showAllEvents} click":function(c){a(c).hide(),b.eventItems().removeClass("hide")},"{showAllProjects} click":function(c){a(c).hide(),b.projectItems().removeClass("hide")},"{showAllFilters} click":function(c){a(c).hide(),b.appFilters().removeClass("hide")},updateHeading:function(a,c){b.heading().find("[data-heading-title]").html(a),b.heading().find("[data-heading-desc]").html(c)},updatingContents:function(){b.element.addClass("loading")},updateContents:function(c){b.element.removeClass("loading"),a.buildHTML(c).appendTo(b.content())
...
}).fail(function(a,b){console.log(a,b)}),void 0)},create:function(a){return EasySocial.ajax("site/controllers/events/createRecurring",{eventId:b.options.eventId,datetime:a})},completed:function(){b.progress().parent().removeClass("progress-info").addClass("progress-success"),b.form().submit()}}}),b.resolve()}),EasySocial.module("site/dashboard/projects",function(){var b=this;EasySocial.require().library("history").done(function(a){EasySocial.Controller("Dashboard.Projects",{defaultOptions:{"{item}":"[data-dashboard-project-item]","{itemLink}":"[data-dashboard-project-item] > a"}},function(b){return{init:function(){},"{item} click":function(c,d){d.preventDefault(),a(".es-streams").removeClass("no-stream");
        {var e=a(c).data("type"),f=a(c).data("id");a(c).data("description")}b.element.removeClass("has-notice"),a(c).find("a").route(),b.parent.content().html(""),b.parent.updatingContents(),b.element.addClass("loading"),EasySocial.ajax("site/controllers/dashboard/getStream",{type:e,id:f,view:"dashboard"}).done(function(a){b.parent.updateContents(a)})}}}),b.resolve()})}),EasySocial.module("site/projects/browser",function(a){var b=this;EasySocial.require().library("popbox").script("site/projects/guestState").language("COM_EASYSOCIAL_PROJECTS_DETECTING_LOCATION").view("site/loading/small").done(function(){EasySocial.Controller("Projects.Browser",{defaultOptions:{"{filters}":"[data-projects-filters] > li","{content}":"[data-projects-content]","{list}":"[data-projects-list]","{items}":"[data-projects-item]","{sort}":"[data-projects-sorting] a","{calendar}":"[data-projects-calendar]","{pastFilter}":"[data-projects-past]","{pastLink}":"[data-projects-past-link]","{prevDate}":"[data-projects-nav-prevdate]","{nextDate}":"[data-projects-nav-nextdate]","{radius}":"[data-projects-radius]","{nearbyTitle}":"[data-projects-nearby-title]",filter:null,categoryid:0,delayed:!1,includePast:!1,ordering:"start",hasLocation:!1,userLatitude:"",userLongitude:"",distance:10,group:null,view:{loadingContent:"site/loading/small"}}},function(b){return{init:function(){b.options.filter=b.element.data("filter"),b.options.categoryid=b.element.data("categoryid"),b.renderCalendar(),b.initItems(),b.options.delayed&&b.delayedInit()
},delayedInit:function(){if("nearby"===b.options.filter){var c=function(){EasySocial.ajax("site/controllers/projects/getProjects",{filter:b.options.filter,latitude:b.options.userLatitude,longitude:b.options.userLongitude,distance:b.options.distance,ordering:b.options.ordering,includePast:b.options.includePast}).done(function(a){b.element.removeClass("loading"),b.content().html(a),b.initItems()})};if(b.options.hasLocation&&b.options.userLatitude&&b.options.userLongitude)return c();EasySocial.require().library("gmaps").done(function(){a.GMaps.geolocate({success:function(a){return b.options.userLatitude=a.coords.latitude,b.options.userLongitude=a.coords.longitude,c()
}})})}},renderCalendar:function(){EasySocial.ajax("site/views/projects/renderCalendar",{}).done(function(a){b.calendar().html(a).addController("EasySocial.Controller.Projects.Browser.Calendar",{"{parent}":b}),b.calendar().trigger("calendarLoaded")})},initItems:function(){b.items().addController("EasySocial.Controller.Projects.Browser.Item",{"{parent}":b})},"{filters} click":function(a,c){return c.preventDefault(),b.filters().removeClass("active"),a.addClass("active"),b.content().html("&nbsp;"),a.find("a").route(),b.options.filter=a.data("projects-filters-type"),b.options.categoryid=a.data("projects-filters-categoryid"),"nearby"==b.options.filter?b.filterByNearby():(b.element.addClass("loading"),EasySocial.ajax("site/controllers/projects/getProjects",{filter:b.options.filter,categoryid:b.options.categoryid}).done(function(a){b.element.removeClass("loading"),b.content().html(a),b.initItems()
}),void 0)},filterByNearby:function(){var c=function(){EasySocial.ajax("site/controllers/projects/getProjects",{filter:b.options.filter,latitude:b.options.userLatitude,longitude:b.options.userLongitude}).done(function(a){b.element.removeClass("loading"),b.content().html(a),b.initItems()})};return b.options.hasLocation&&b.options.userLatitude&&b.options.userLongitude?(b.element.addClass("loading"),c()):(b.content().html('<div class="es-detecting-location"><i class="fa fa-globe es-muted"></i> '+a.language("COM_EASYSOCIAL_PROJECTS_DETECTING_LOCATION")+' <i class="icon-loader"></i></div>'),EasySocial.require().library("gmaps").done(function(){a.GMaps.geolocate({success:function(a){return b.options.userLatitude=a.coords.latitude,b.options.userLongitude=a.coords.longitude,b.options.hasLocation=!0,c()
}})}),void 0)},"{sort} click":function(a,c){c.preventDefault(),b.sort().removeClass("active"),a.addClass("active"),b.list().html(b.view.loadingContent());var d=a.data("ordering"),e=a.data("filter"),f=a.data("categoryid"),g=b.pastFilter().is(":checked")?1:0;return b.setPastLink(),b.setSortLink(),a.route(),"nearby"===e?(EasySocial.ajax("site/controllers/projects/getProjects",{filter:b.options.filter,latitude:b.options.userLatitude,longitude:b.options.userLongitude,distance:b.options.distance,ordering:d,sort:1,includePast:g}).done(function(a){b.list().html(a),b.initItems()
}),void 0):(EasySocial.ajax("site/controllers/projects/getProjects",{filter:e,categoryid:f,ordering:d,sort:1,includePast:g,group:b.options.group}).done(function(a){b.list().html(a),b.initItems()}),void 0)},"{pastFilter} change":function(a){var c=b.sort(".active"),d=a.is(":checked")?1:0,e=c.data("ordering"),f=c.data("filter"),g=c.data("categoryid");return b.list().html(b.view.loadingContent()),b.pastLink().route(),b.setPastLink(),b.setSortLink(),"nearby"===f?(EasySocial.ajax("site/controllers/projects/getProjects",{filter:b.options.filter,latitude:b.options.userLatitude,longitude:b.options.userLongitude,distance:b.options.distance,ordering:e,sort:1,includePast:d}).done(function(a){b.list().html(a),b.initItems()
}),void 0):(EasySocial.ajax("site/controllers/projects/getProjects",{filter:f,categoryid:g,ordering:e,sort:1,includePast:d,group:b.options.group}).done(function(a){b.list().html(a),b.initItems()}),void 0)},"{pastLink} click":function(a,c){c.preventDefault(),b.pastFilter().trigger("click")},setPastLink:function(){var a=b.pastLink(),c=b.pastFilter().is(":checked")?1:0,d=b.sort(".active").data("ordering"),e=a.data(d+"-"+(c?"nopast":"past"));a.attr("href",e)},setSortLink:function(){var c=b.pastFilter().is(":checked")?1:0;
    a.each(b.sort(),function(d,e){var e=a(e);e.attr("href",b.pastLink().data(e.data("ordering")+"-"+(c?"past":"nopast")))})},"{prevDate} click":function(a,c){c.preventDefault(),a.route(),b.filters().removeClass("active"),b.element.addClass("loading"),b.content().html("&nbsp;"),EasySocial.ajax("site/controllers/projects/getProjects",{filter:"date",date:a.data("projects-nav-prevdate")}).done(function(a,c){b.element.removeClass("loading"),b.content().html(a),b.initItems(),c.isToday&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="date"]').addClass("active")),c.isTomorrow&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="tomorrow"]').addClass("active")),c.isCurrentMonth&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="month"]').addClass("active")),c.isCurrentYear&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="year"]').addClass("active"))
})},"{nextDate} click":function(a,c){c.preventDefault(),a.route(),b.filters().removeClass("active"),b.element.addClass("loading"),b.content().html("&nbsp;"),EasySocial.ajax("site/controllers/projects/getProjects",{filter:"date",date:a.data("projects-nav-nextdate")}).done(function(a,c){b.element.removeClass("loading"),b.content().html(a),b.initItems(),c.isToday&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="date"]').addClass("active")),c.isTomorrow&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="tomorrow"]').addClass("active")),c.isCurrentMonth&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="month"]').addClass("active")),c.isCurrentYear&&(b.filters().removeClass("active"),b.filters('[data-projects-filters-type="year"]').addClass("active"))
})},"{radius} change":function(c){var e=b.sort(".active"),f=b.pastFilter().is(":checked")?1:0,g=e.data("ordering"),j=(e.data("filter"),e.data("categoryid"),c.val());b.options.distance=j,b.list().html(b.view.loadingContent()),EasySocial.ajax("site/controllers/projects/getProjects",{filter:"nearby",latitude:b.options.userLatitude,longitude:b.options.userLongitude,distance:b.options.distance,ordering:g,includePast:f,sort:1}).done(function(c,d){b.list().html(c),b.initItems(),History.pushState({state:1},document.title,d.hrefs[g][f?"past":"nopast"]),b.pastLink().attr("href",d.hrefs[g][f?"nopast":"past"]),a.each(b.sort(),function(c,e){var e=a(e);
    e.attr("href",d.hrefs[e.data("ordering")][f?"past":"nopast"]),b.pastLink().attr("data-"+e.data("ordering")+"-past",d.hrefs[e.data("ordering")].past),b.pastLink().attr("data-"+e.data("ordering")+"-nopast",d.hrefs[e.data("ordering")].nopast)}),b.nearbyTitle().text(d.title)})}}}),EasySocial.Controller("Projects.Browser.Item",{defaultOptions:{id:null,"{action}":"[data-item-action]","{unfeature}":"[data-item-unfeature]","{feature}":"[data-item-feature]","{unpublish}":"[data-item-unpublish]","{delete}":"[data-item-delete]","{guestStateWrap}":"[data-guest-state-wrap]"}},function(a){return{init:function(){a.options.id=a.element.data("id"),a.initGuestStates()
},initGuestStates:function(){a.guestStateWrap().addController("EasySocial.Controller.Projects.GuestState")},"{action} click":function(b){EasySocial.dialog({content:EasySocial.ajax("site/views/projects/itemActionDialog",{id:a.options.id,action:b.data("item-action"),from:"list"})})},"{delete} click":function(){EasySocial.dialog({content:EasySocial.ajax("site/views/projects/deleteProjectDialog",{id:a.options.id})})}}}),EasySocial.Controller("Projects.Browser.Calendar",{defaultOptions:{"{nav}":"[data-calendar-nav]","{day}":".day","{month}":"[data-month]",view:{loading:"site/loading/small"}}},function(b){return{init:function(){},"{self} calendarLoaded":function(){b.day(".has-projects").each(function(b,c){c=a(c);
    var d=c.find(".project-details").html();c.popbox({content:d,id:"fd",component:"es",type:"projects-calendar-filter",position:"bottom-left",toggle:"hover"})});var c=b.month(".has-projects");if(c.length>0){var d=c.find(".project-details").html();c.popbox({content:d,id:"fd",component:"es",type:"projects-calendar-filter",position:"bottom-left",toggle:"hover"})}},"{nav} click":function(a){var d=a.data("calendar-nav");b.element.html(b.view.loading()),EasySocial.ajax("site/views/projects/renderCalendar",{date:d}).done(function(a){b.element.html(a).trigger("calendarLoaded")
})},"{day} click":function(a,c){c.preventDefault(),a.find("a[data-route]:first").route(),b.loadProjects(a.data("date"))},"{day} popboxActivate":function(c,d,e){e.tooltip.find("a[data-route]").on("click",function(c){c.preventDefault(),a(this).route(),b.loadProjects(a(this).data("date"))})},"{month} click":function(a,c){c.preventDefault(),a.find("a[data-route]:first").route(),b.loadProjects(a.data("month"))},"{month} popboxActivate":function(c,d,e){e.tooltip.find("a[data-route]").on("click",function(c){c.preventDefault(),a(this).route(),b.loadProjects(a(this).data("month"))
})},loadProjects:function(a){b.parent.filters().removeClass("active"),b.parent.element.addClass("loading"),b.parent.content().html("&nbsp;"),EasySocial.ajax("site/controllers/projects/getProjects",{filter:"date",date:a}).done(function(a,c){b.parent.element.removeClass("loading"),b.parent.content().html(a),b.parent.initItems(),c.isToday&&(b.parent.filters().removeClass("active"),b.parent.filters('[data-projects-filters-type="date"]').addClass("active")),c.isTomorrow&&(b.parent.filters().removeClass("active"),b.parent.filters('[data-projects-filters-type="tomorrow"]').addClass("active")),c.isCurrentMonth&&(b.parent.filters().removeClass("active"),b.parent.filters('[data-projects-filters-type="month"]').addClass("active")),c.isCurrentYear&&(b.parent.filters().removeClass("active"),b.parent.filters('[data-projects-filters-type="year"]').addClass("active"))
})}}}),b.resolve()})}),EasySocial.module("site/projects/guestState",function(){var b=this;EasySocial.require().language("COM_EASYSOCIAL_PROJECTS_GUEST_PENDING").done(function(a){EasySocial.Controller("Projects.GuestState",{defaultOptions:{id:null,allowMaybe:1,allowNotGoingGuest:1,hidetext:1,refresh:!1,"{guestAction}":"[data-guest-action]","{guestState}":"[data-guest-state]","{request}":"[data-guest-request]","{withdraw}":"[data-guest-withdraw]","{respond}":"[data-guest-respond]"}},function(b){return{init:function(){b.options.id=b.element.data("id"),b.options.allowMaybe=b.element.data("allowmaybe"),b.options.allowNotGoingGuest=b.element.data("allownotgoingguest"),b.options.hidetext=b.element.data("hidetext"),b.options.refresh=b.element.is("[data-refresh]")
},showError:function(a){EasySocial.dialog({content:a})},stateClasses:{going:"btn-es-success",maybe:"btn-es-info",notgoing:"btn-es-danger"},"{guestAction} click":function(c){var d=c.data("guestAction");if("state"===d){var e=c.data("guestState");b.guestAction().removeClass("btn-es-success btn-es-info btn-es-danger"),c.addClass(b.stateClasses[e]),"notgoing"!==e||b.options.allowNotGoingGuest?b.response(e).done(function(){return b.options.refresh?location.reload():void 0}).fail(function(a){c.removeClass(b.stateClasses[d]),b.showError(a)
}):EasySocial.dialog({content:EasySocial.ajax("site/views/projects/notGoingDialog",{id:b.options.id}),bindings:{"{closeButton} click":function(){EasySocial.ajax("site/views/projects/refreshGuestState",{id:b.options.id,hidetext:b.options.hidetext}).done(function(a){b.element.html(a),EasySocial.dialog().close()})},"{submitButton} click":function(){b.response("notgoing").done(function(){return b.options.refresh?location.reload():(EasySocial.ajax("site/views/projects/refreshGuestState",{id:b.options.id,hidetext:b.options.hidetext}).done(function(a){b.element.html(a),EasySocial.dialog().close()
}),void 0)})}}})}"request"===d&&EasySocial.dialog({content:EasySocial.ajax("site/views/projects/requestDialog",{id:b.options.id}),bindings:{"{submitButton} click":function(){c.attr("data-guest-action","withdraw").data("guestAction","withdraw").removeAttr("data-guest-request").attr("data-guest-withdraw","").text(a.language("COM_EASYSOCIAL_PROJECTS_GUEST_PENDING")),b.response(d),EasySocial.dialog().close()}}}),"withdraw"===d&&EasySocial.dialog({content:EasySocial.ajax("site/views/projects/withdrawDialog",{id:b.options.id}),bindings:{"{submitButton} click":function(){b.response("withdraw").done(function(){EasySocial.ajax("site/views/projects/refreshGuestState",{id:b.options.id,hidetext:b.options.hidetext}).done(function(a){b.element.html(a),EasySocial.dialog().close()
})})}}}),"attend"===d&&b.response("going").done(function(){EasySocial.ajax("site/views/projects/refreshGuestState",{id:b.options.id,hidetext:b.options.hidetext}).done(function(a){return b.options.refresh?location.reload():(void 0!==a&&(b.element.html(a),EasySocial.dialog().close()),void 0)})})},response:function(a){return EasySocial.ajax("site/controllers/projects/guestResponse",{id:b.options.id,state:a})}}}),b.resolve()})}),EasySocial.module("site/projects/buttonState",function(){var b=this;EasySocial.require().language("COM_EASYSOCIAL_PROJECTS_GUEST_PENDING").done(function(a){EasySocial.Controller("Projects.ButtonState",{defaultOptions:{id:null,allowMaybe:1,allowNotGoingGuest:1,hidetext:1,refresh:!1,isPopbox:0,"{guestAction}":"[data-guest-action]","{guestState}":"[data-guest-state]","{request}":"[data-guest-request]","{withdraw}":"[data-guest-withdraw]","{respond}":"[data-guest-respond]","{rsvpButton}":"[data-project-rsvp-button]"}},function(b){return{init:function(){b.options.id=b.element.data("id"),b.options.allowMaybe=b.element.data("allowmaybe"),b.options.allowNotGoingGuest=b.element.data("allownotgoingguest"),b.options.hidetext=b.element.data("hidetext"),b.options.isPopbox=b.element.data("ispopbox")
},showError:function(a){EasySocial.dialog({content:a.message})},stateClasses:{going:"btn-es-success",maybe:"btn-es-info",notgoing:"btn-es-danger"},refreshButton:function(){EasySocial.ajax("site/views/projects/refreshButtonState",{id:b.options.id,hidetext:b.options.hidetext,isPopbox:b.options.isPopbox}).done(function(a){b.element.replaceWith(a)})},"{rsvpButton} popboxActivate":function(c,d,e){var f="div#"+e.id+".popbox-"+e.type+" [data-project-button-container]";a(f).addController("EasySocial.Controller.Projects.ButtonState.Popbox",{"{parent}":b})
},"{guestAction} click":function(a){b.doAction(a)},doAction:function(c){var d=c.data("guestAction");if("state"===d){var e=c.data("guestState");"notgoing"!==e||b.options.allowNotGoingGuest?b.response(e).done(function(){b.refreshButton()}).fail(function(a){c.removeClass(b.stateClasses[d]),b.showError(a)}):EasySocial.dialog({content:EasySocial.ajax("site/views/projects/notGoingDialog",{id:b.options.id}),bindings:{"{closeButton} click":function(){b.refreshButton(),EasySocial.dialog().close()},"{submitButton} click":function(){b.response("notgoing").done(function(){b.refreshButton(),EasySocial.dialog().close()
})}}})}"request"===d&&EasySocial.dialog({content:EasySocial.ajax("site/views/projects/requestDialog",{id:b.options.id}),bindings:{"{submitButton} click":function(){c.attr("data-guest-action","withdraw").data("guestAction","withdraw").removeAttr("data-guest-request").attr("data-guest-withdraw","").text(a.language("COM_EASYSOCIAL_PROJECTS_GUEST_PENDING")),b.response(d),EasySocial.dialog().close()}}}),"withdraw"===d&&EasySocial.dialog({content:EasySocial.ajax("site/views/projects/withdrawDialog",{id:b.options.id}),bindings:{"{submitButton} click":function(){b.response("withdraw").done(function(){b.refreshButton(),EasySocial.dialog().close()
})}}}),"attend"===d&&b.response("going").done(function(){b.refreshButton(),EasySocial.dialog().close()})},response:function(a){return EasySocial.ajax("site/controllers/projects/guestResponse",{id:b.options.id,state:a})}}}),EasySocial.Controller("Projects.ButtonState.Popbox",{defaultOptions:{"{guestAction}":"[data-guest-action]"}},function(a){return{init:function(){console.log("Projects.ButtonState.Popbox")},"{guestAction} click":function(b){a.parent.doAction(b)}}}),b.resolve()})}),EasySocial.module("site/projects/create",function(){var b=this;
    EasySocial.require().script("validate","field").done(function(){EasySocial.Controller("Projects.Create",{defaultOptions:{previousLink:null,"{fields}":"[data-create-field]","{previous}":"[data-create-previous]","{next}":"[data-create-submit]"}},function(a){return{init:function(){a.fields().addController("EasySocial.Controller.Field.Base")},"{previous} click":function(){window.location=a.options.previousLink},"{next} click":function(b){b.enabled()&&(b.disabled(!0),b.addClass("btn-loading"),a.element.validate().done(function(){b.removeClass("btn-loading"),b.enabled(!0),a.element.submit()
    }).fail(function(){b.removeClass("btn-loading"),b.enabled(!0),EasySocial.dialog({content:EasySocial.ajax("site/views/profile/showFormError")})}))}}}),b.resolve()})}),EasySocial.module("site/projects/createRecurring",function(){var b=this;EasySocial.Controller("Projects.CreateRecurring",{defaultOptions:{schedule:[],projectId:null,"{progress}":"[data-progress-bar]","{form}":"[data-form]"}},function(a){return{init:function(){a.start()},counter:0,start:function(){return void 0===a.options.schedule[a.counter]?a.completed():(a.create(a.options.schedule[a.counter]).done(function(){a.counter++;
    var b=Math.ceil(a.counter/a.options.schedule.length*100);a.progress().css({width:b+"%"}),a.start()}).fail(function(a){console.log(a)}),void 0)},create:function(b){return EasySocial.ajax("site/controllers/projects/createRecurring",{projectId:a.options.projectId,datetime:b})},completed:function(){a.progress().parent().removeClass("progress-info").addClass("progress-success"),a.form().submit()}}}),b.resolve()}),EasySocial.module("site/projects/edit",function(a){var b=this;EasySocial.require().script("validate","field").done(function(){EasySocial.Controller("Projects.Edit",{defaultOptions:{id:null,isRecurring:0,hasRecurring:0,"{form}":"[data-form]","{nav}":"[data-step-nav]","{content}":"[data-step-content]","{fields}":"[data-edit-field]","{saveButton}":"[data-edit-save]","{saveApply}":'input[name="applyRecurring"]'}},function(b){return{init:function(){b.fields().addController("EasySocial.Controller.Field.Base",{mode:"edit"})
},errorFields:[],"{nav} click":function(c){var e=a(c).data("for");b.content().hide(),b.nav().removeClass("active"),c.addClass("active"),b.content().filterBy("id",e).show().find(b.fields.selector).trigger("show")},"{nav} error":function(a){a.addClass("error")},"{nav} clear":function(a){b.errorFields.length<1&&a.removeClass("error")},"{fields} error":function(a){b.triggerStepError(a)},"{fields} clear":function(a){b.clearStepError(a)},"{fieldItem} onError":function(a){b.triggerStepError(a)},triggerStepError:function(c){var d=c.data("id"),e=c.parents(b.content.selector).data("id");
    a.inArray(d,b.errorFields)<0&&b.errorFields.push(d),b.nav().filterBy("for",e).trigger("error")},clearStepError:function(c){var d=c.data("id"),e=c.parents(b.content.selector).data("id");b.errorFields=a.without(b.errorFields,d),b.nav().filterBy("for",e).trigger("clear")},"{saveButton} click":function(a,c){c.preventDefault(),a.addClass("btn-loading"),b.form().validate().done(function(){"all"===a.data("editSave")&&b.saveApply().val(1),b.form().submit()}).fail(function(){a.removeClass("btn-loading"),EasySocial.dialog({content:EasySocial.ajax("site/views/profile/showFormError")})
})}}}),b.resolve()})}),EasySocial.module("site/projects/item",function(){var b=this;EasySocial.template("info/item",'<li data-sidebar-item><a class="ml-20" href="[%= url %]" title="[%= title %]" data-info-item data-info-index="[%= index %]"><i class="fa fa-info-circle mr-5"></i> [%= title %]</a></li>'),EasySocial.require().script("site/friends/suggest","site/projects/guestState").view("site/loading/small").library("history").done(function(a){EasySocial.Controller("Projects.Item",{defaultOptions:{id:null,"{filterStreamList}":"[data-filter-stream-list]","{sidebarItem}":"[data-sidebar-item]","{addFilter}":"[data-filter-add]","{editFilter}":"[data-filter-edit]","{filterStream}":"[data-filter-stream]","{filterApp}":"[data-filter-app]","{showAllFilters}":"[data-filter-showall]","{apps}":"[data-app-item]","{content}":"[data-content]","{saveHashtag}":"[data-hashtag-filter-save]","{invite}":"[data-action-invite]","{unpublish}":"[data-action-unpublish]","{delete}":"[data-action-delete]","{guestStateWrap}":"[data-guest-state-wrap]","{info}":"[data-info]","{infoItem}":"[data-info-item]","{menuItem}":"[data-dashboardSidebar-menu]",view:{infoItem:"info/item",loading:"site/loading/small"}}},function(b){return{init:function(){b.initGuestStates()
},initGuestStates:function(){b.guestStateWrap().addController("EasySocial.Controller.Projects.GuestState")},setActive:function(a){b.sidebarItem().removeClass("active"),a.parents(b.sidebarItem.selector).addClass("active")},setLoading:function(){b.content().html(""),b.element.addClass("loading")},updateContents:function(a){b.element.removeClass("loading"),b.content().html(a)},"{showAllFilters} click":function(a){a.hide(),b.sidebarItem().show()},"{editFilter} click":function(a,c){c.preventDefault(),a.route(),b.setLoading(),b.getFilter(a.data("id")),b.setActive(a.parents("[data-sidebar-item]"))
},"{addFilter} click":function(a,c){c.preventDefault(),a.route(),b.setActive(a),b.setLoading(),b.getFilter(0)},getFilter:function(a){EasySocial.ajax("site/controllers/projects/getFilter",{filterId:a,projectId:b.options.id}).always(function(a){b.updateContents(a)})},"{filterApp} click":function(a,c){c.preventDefault(),a.route(),b.setActive(a),b.setLoading(),b.getStream(a.data("id"),"apps")},"{filterStream} click":function(a,c){c.preventDefault(),a.route(),b.setActive(a),b.setLoading(),b.getStream(a.data("id"),a.data("type"))
},"{menuItem} click":function(c){b.menuItem().removeClass("active"),a(c).addClass("active")},getStream:function(a,c){EasySocial.ajax("site/controllers/projects/getStream",{id:a,type:c,view:"projects",projectId:b.options.id}).always(function(a){b.updateContents(a)})},"{saveHashtag} click":function(c){var d=c.data("tag");EasySocial.dialog({content:EasySocial.ajax("site/views/stream/confirmSaveFilter",{tag:d}),bindings:{"{saveButton} click":function(){this.inputWarning().hide();var c=this.inputTitle().val();return""==c?(this.inputWarning().show(),void 0):(EasySocial.ajax("site/controllers/projects/addFilter",{title:c,tag:d,id:b.options.id}).done(function(c,d){var e=a.buildHTML(c);
    b.filterStreamList().append(e),EasySocial.dialog(d),setTimeout(function(){EasySocial.dialog().close()},2e3)}),void 0)}}})},"{apps} click":function(a,c){c.preventDefault(),a.route(),b.setActive(a),b.setLoading(),EasySocial.ajax("site/controllers/projects/getAppContents",{appId:a.data("app-id"),projectId:b.options.id}).always(function(a){b.updateContents(a)})},"{info} click":function(c,d){d.preventDefault(),c.route(),b.setActive(c),b.setLoading();var e=c.data("loaded");return e?(b.infoItem().eq(0).trigger("click"),void 0):(c.enabled()&&(c.disabled(!0),EasySocial.ajax("site/controllers/projects/initInfo",{projectId:b.options.id}).done(function(d){c.data("loaded",1);
    var e=c.parent("[data-sidebar-item]");a.each(d.reverse(),function(a,c){c.hide||e.after(b.view.infoItem({url:c.url,title:c.title,index:c.index})),c.html&&(b.updateContents(c.html),b.content().find("[data-field]").trigger("onShow"))});var f=b.infoItem().eq(0);b.setActive(f),a(document).prop("title",f.attr("title")),c.enabled(!0)}).fail(function(a){c.enabled(!0),b.updateContents(a.message)})),void 0)},"{infoItem} click":function(a,c){c.preventDefault(),a.route(),b.setActive(a),b.setLoading();var d=a.data("info-index");
    EasySocial.ajax("site/controllers/projects/getInfo",{projectId:b.options.id,index:d}).done(function(a){b.updateContents(a),b.content().find("[data-field]").trigger("onShow")}).fail(function(a){b.updateContents(a.message)})},"{invite} click":function(){EasySocial.dialog({content:b.view.loading(),width:400,heigth:150}),EasySocial.ajax("site/views/projects/inviteFriendsDialog",{id:b.options.id}).done(function(a){EasySocial.dialog({content:a})})},"{unpublish} click":function(){EasySocial.dialog({content:EasySocial.ajax("site/views/projects/unpublishProjectDialog",{id:b.options.id})})
},"{delete} click":function(){EasySocial.dialog({content:EasySocial.ajax("site/views/projects/deleteProjectDialog",{id:b.options.id})})}}}),b.resolve()})}),EasySocial.module("site/projects/update",function(a){var b=this;EasySocial.Controller("Projects.Update",{defaultOptions:{postdata:{},updateids:[],schedule:[],projectId:null,"{progress}":"[data-progress-bar]","{form}":"[data-form]"}},function(b){return{init:function(){b.startUpdate()},updateCounter:0,createCounter:0,updateProgressBar:function(){var a=Math.ceil((b.updateCounter+b.createCounter)/(b.options.updateids.length+b.options.schedule.length)*100);
    b.progress().css({width:a+"%"})},startUpdate:function(){return void 0===b.options.updateids[b.updateCounter]?b.startCreate():(b.update(b.options.updateids[b.updateCounter]).done(function(){b.updateCounter++,b.updateProgressBar(),b.startUpdate()}).fail(function(a,b){console.log(a,b)}),void 0)},update:function(c){var d=a.extend({},b.options.postdata,{id:c,applyRecurring:1});return EasySocial.ajax("site/controllers/projects/update",d)},startCreate:function(){return void 0===b.options.schedule[b.createCounter]?b.completed():(b.create(b.options.schedule[b.createCounter]).done(function(){b.createCounter++,b.updateProgressBar(),b.startCreate()
}).fail(function(a,b){console.log(a,b)}),void 0)},create:function(a){return EasySocial.ajax("site/controllers/projects/createRecurring",{projectId:b.options.projectId,datetime:a})},completed:function(){b.progress().parent().removeClass("progress-info").addClass("progress-success"),b.form().submit()}}}),b.resolve()}),EasySocial.module("site/explorer",function(a){var b=this,c="is-selected",d=".is-selected",f=".is-checked",g=":not(.is-selected)",h="is-active",i=".is-active",j="fileSelect",k="fileDeselect",l="folderActivate",m="folderDeactivate",n="fileInsert",o="folderInsert",p="fileRemove",q="folderRemove",r="fileUse",s="serviceRequest";
