...
?>
<div class="es-content" data-group-news-item data-id="<?php echo $news->id; ?>" data-group-id="<?php echo $project->id; ?>">
    <div class="es-content-wrap">
        <div class="app-news app-group">

            <div class="mb-5">
                <a href="<?php echo FRoute::projects(array('layout' => 'item', 'id' => $project->getAlias(), 'appId' => $app->getAlias())); ?>">&larr; <?php echo JText::_('COM_EASYSOCIAL_BACK_TO_NEWS'); ?></a>
            </div>
            ...
            <div class="fd-cf group-news-item">
                    ...
                    <div class="fd-cf ">
                        <h3 class="pull-left">
                            <a href="<?php echo FRoute::apps(array('layout' => 'canvas', 'customView' => 'item', 'uid' => $project->getAlias(), 'type' => SOCIAL_TYPE_PROJECT, 'id' => $app->getAlias(), 'newsId' => $news->id), false); ?>"><?php echo $news->get('title'); ?></a>
                        </h3>
                        <div class="pull-right btn-group mt-20">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?php echo FRoute::apps(array('layout' => 'canvas', 'customView' => 'form', 'uid' => $project->getAlias(), 'type' => SOCIAL_TYPE_PROJECT, 'id' => $app->getAlias(), 'newsId' => $news->id)); ?>">
                                        <?php echo JText::_('APP_PROJECT_NEWS_EDIT_ITEM'); ?>
                                    </a>
                                </li>
                                <li class="divider"></li>
                                <li>
                                    <a href="javascript:void(0);" data-news-delete><?php echo JText::_('APP_PROJECT_NEWS_DELETE_ITEM'); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="group-news-meta">
                        <ul class="fd-reset-list">
                            ...
                            <li>
                                <i class="fa fa-eye"></i> <?php echo JText::sprintf(FD::string()->computeNoun('APP_PROJECT_NEWS_HITS', $news->hits), $news->hits); ?>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
                    ...
                    <div class="group-news-actions">
                        <div class="es-action-wrap pl-0">
                            <ul class="fd-reset-list es-action-feedback">
                                ...
                                <li>
                                    <?php echo FD::sharing(array('url' => FRoute::apps(array('layout' => 'canvas', 'customView' => 'item', 'uid' => $project->getAlias(), 'type' => SOCIAL_TYPE_PROJECT, 'id' => $app->getAlias(), 'articleId' => $news->id), false), 'display' => 'dialog', 'text' => JText::_('COM_EASYSOCIAL_STREAM_SOCIAL'), 'css' => 'fd-small'))->getHTML(false); ?>
                                </li>
                            </ul>
                        </div>
