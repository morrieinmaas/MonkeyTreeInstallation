...
class SocialSharesHelperStream extends SocialProjectSharesHelper
{
    public function getContent()
    {
        ...
        $html = $theme->output('apps/project/shares/streams/stream/content');
    ...
    public function getTitle()
    {
        ...
        $title = $theme->output('apps/project/shares/streams/stream/title');
