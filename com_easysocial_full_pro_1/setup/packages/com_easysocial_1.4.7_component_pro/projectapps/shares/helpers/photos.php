...
class SocialProjectSharesHelperPhotos extends SocialProjectSharesHelper
{
    public function getContent()
    {
        ...
        $app = FD::table('App');
        $app->load(array('element' => 'photo', 'group' => SOCIAL_APPS_GROUP_PROJECT, 'type' => SOCIAL_TYPE_APPS));
        ...
        $html = $theme->output('apps/project/shares/streams/photos/content');
    ...
    public function getTitle()
    {
        ...
        $title = $theme->output('apps/project/shares/streams/photos/title');
