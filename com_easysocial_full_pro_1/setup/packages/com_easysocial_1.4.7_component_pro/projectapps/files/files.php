...
class SocialProjectAppFiles extends SocialAppItem
{
    /**
    ...
    public function appListing($view, $id, $type)
    {
        ...
        // Determines if this project has access to files
        ...
        $guest = $project->getGuest(FD::user()->id);
    ...
    {
        $allowed = array('files.project.uploaded');
    ...
    public function onAfterLikeSave(&$likes)
    {
        ...
        $emailOptions = array(
            'title' => 'APP_PROJECT_FILES_EMAILS_LIKE_ITEM_SUBJECT',
            'template' => 'apps/project/files/like.file.item',
        ...
        $emailOptions['title'] = 'APP_PROJECT_FILES_EMAILS_LIKE_INVOLVED_SUBJECT';
        $emailOptions['template'] = 'apps/project/files/like.file.involved';
    ...
    public function onAfterCommentSave(&$comment)
    {
        ...
        $emailOptions = array(
            'title' => 'APP_PROJECT_FILES_EMAILS_COMMENT_ITEM_SUBJECT',
            'template' => 'apps/project/files/comment.file.item',
        ...
        $emailOptions['title'] = 'APP_PROJECT_FILES_EMAILS_COMMENT_INVOLVED_SUBJECT';
        $emailOptions['template'] = 'apps/project/files/comment.file.involved';
    ...
    public function onPrepareStream(SocialStreamItem &$item, $includePrivacy = true)
    {
        ...
        if (!$project || !$project->canViewItem()) {
            return;
        }
