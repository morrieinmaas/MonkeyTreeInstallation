...
class SocialProjectAppFilesHookNotificationLikes
{
    /**
    ...
    public function execute(&$item)
    {
        ...
        if ($item->context_type == 'files.project.uploaded') {
            ...
            {
                $langString = FD::string()->computeNoun('APP_PROJECT_FILES_USER_LIKES_YOUR_FILE', count($users));
            ...
            $langString = FD::string()->computeNoun('APP_PROJECT_FILES_USER_LIKES_USERS_FILE', count($users));
