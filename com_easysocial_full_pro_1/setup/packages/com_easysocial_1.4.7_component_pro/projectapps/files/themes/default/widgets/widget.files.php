...
<div class="es-widget">
    <div class="es-widget-head">
        <div class="pull-left widget-title"><?php echo JText::_('APP_PROJECT_FILES_WIDGET_TITLE'); ?></div>
    </div>
    ...
    <div class="es-widget-body recent-files">
            ...
            <li>
                ...
                <div class="row author-info">
                    <div class="col-md-12 fd-small">
                        <i class="fa fa-user"></i> <?php echo JText::sprintf('APP_PROJECT_FILES_UPLOADED_BY', $this->html('html.user', $file->user_id, true)); ?>
                    </div>
                </div>
            </li>
            <?php } ?>
        ...
        <?php } else { ?>
        <div class="fd-small">
            <?php echo JText::_('APP_PROJECT_FILES_EMPTY_FILES'); ?>
        </div>
        <?php } ?>
    </div>
</div>
