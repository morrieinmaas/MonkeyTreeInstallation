...
<dialog>
    ...
    <title><?php echo JText::_('APP_PROJECT_TASKS_CONFIRM_DELETE_MILESTONE_DIALOG_TITLE'); ?></title>
    <content>
        <p><?php echo JText::_('APP_PROJECT_TASKS_CONFIRM_DELETE_MILESTONE_DIALOG_DESC'); ?></p>
    </content>
    <buttons>
