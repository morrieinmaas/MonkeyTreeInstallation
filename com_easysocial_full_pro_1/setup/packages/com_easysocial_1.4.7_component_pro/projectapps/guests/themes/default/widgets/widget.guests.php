...
<div class="es-widget es-widget-guests">
    <div class="es-widget-head">
        <div class="pull-left widget-title"><?php echo JText::_('APP_PROJECT_GUESTS_WIDGET_GUESTS_TITLE'); ?></div>

        <?php if (!empty($goingGuests) || !empty($maybeGuests) || !empty($notGoingGuests)) { ?>
            <a class="fd-small pull-right" href="<?php echo $link; ?>"><?php echo JText::_('APP_PROJECT_GUESTS_VIEW_ALL_GUESTS');?></a>
        <?php } ?>
    </div>
    <div class="es-widget-body">

        <ul class="fd-nav es-widget-tab" role="tablist">
            <li class="active"><a href="#es-going-guests" role="tab" data-bs-toggle="tab"><?php echo JText::_('APP_PROJECT_GUESTS_WIDGET_GUESTS_TAB_GOING'); ?>
                <?php if ($totalGoing > 0){ ?>
                <span class="widget-label">(<?php echo $totalGoing;?>)</span>
                <?php } ?>
            </a></li>
            <?php if ($allowMaybe) { ?>
            <li><a href="#es-maybe-guests" role="tab" data-bs-toggle="tab"><?php echo JText::_('APP_PROJECT_GUESTS_WIDGET_GUESTS_TAB_MAYBE'); ?>
                <?php if ($totalMaybe > 0){ ?>
            ...
            <li><a href="#es-notgoing-guests" role="tab" data-bs-toggle="tab"><?php echo JText::_('APP_PROJECT_GUESTS_WIDGET_GUESTS_TAB_NOTGOING'); ?>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="es-going-guests">
                <ul class="widget-list-grid">
                    ...
                    <li>
                        <div class="fd-small">
                            <?php echo JText::_('APP_PROJECT_GUESTS_WIDGET_GUESTS_NO_GUESTS_YET'); ?>
                        </div>
                    </li>
                    <?php } ?>
                </ul>
