...
<div class="es-widget">
    <div class="es-widget-head">
        <div class="pull-left widget-title"><?php echo JText::_('APP_PROJECT_GUESTS_FRIENDS_IN_PROJECT_WIDGET_TITLE'); ?></div>
    </div>
    ...
    <div class="es-widget-body">
        ...
        <?php } else { ?>
        <div class="fd-small">
            <?php echo JText::_('APP_PROJECT_GUESTS_WIDGET_NO_FRIENDS'); ?>
        </div>
        <?php } ?>
    </div>
</div>
