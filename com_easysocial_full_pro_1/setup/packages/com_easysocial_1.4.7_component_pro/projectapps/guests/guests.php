...
class SocialProjectAppGuests extends SocialAppItem
{
    public function getFavIcon()
    {
        ...
        $obj->color = '#6bccb4';
        $obj->icon = 'fa-user';
        $obj->label = 'APP_PROJECT_GUESTS_STREAM_TOOLTIP';
    ...
    public function onNotificationLoad(SocialTableNotification &$item)
    {
        ...
        // Only guests.project.going, guests.project.notgoing, guests.project.makeadmin has stream item
        if (in_array($item->cmd, $allowed) && in_array($item->context_type, array('guests.project.going', 'guests.project.notgoing', 'guests.project.makeadmin'))) {
    ...
    public function onPrepareStream(SocialStreamItem &$item, $includePrivacy = true)
    {
        ...
        // "projects" context are processed in the app/project/projects app
        ...
        $item->label = FD::_('APP_PROJECT_GUESTS_STREAM_TOOLTIP', true);
        ...
        // APP_PROJECT_GUESTS_STREAM_OPENGRAPH_GOING
        // APP_PROJECT_GUESTS_STREAM_OPENGRAPH_NOTGOING
        // APP_PROJECT_GUESTS_STREAM_OPENGRAPH_MAKEADMIN
        // Append the opengraph tags
        $item->addOgDescription(JText::sprintf('APP_PROJECT_GUESTS_STREAM_OPENGRAPH_' . strtoupper($item->verb), $actor->getName(), $project->getName()));
    }
