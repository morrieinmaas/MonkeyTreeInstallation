...
<dialog>
    ...
    <title><?php echo JText::_('APP_PROJECT_DISCUSSIONS_DIALOG_DELETE_DISCUSSION_TITLE'); ?></title>
    <content>
        <p><?php echo JText::_('APP_PROJECT_DISCUSSIONS_DIALOG_DELETE_DISCUSSION_DESC'); ?></p>
