        ...
        <div class="es-content-wrap">
            <form action="<?php echo JRoute::_('index.php'); ?>" method="post">
                ...
                <?php if ($discussion->id) { ?>
                    <h3><?php echo JText::_('APP_PROJECT_DISCUSSIONS_EDITING_SUBTITLE'); ?></h3>
                <?php } else { ?>
                    <h3><?php echo JText::_('APP_PROJECT_DISCUSSIONS_CREATE_SUBTITLE'); ?></h3>
                <?php } ?>
                ...
                <div>
                    <input type="text" name="title" value="<?php echo $this->html('string.escape', $discussion->title); ?>"
                        placeholder="<?php echo JText::_('APP_PROJECT_DISCUSSIONS_TITLE_PLACEHOLDER', true); ?>" class="form-control discussion-title mb-10"
                    />

                    <div class="editor-wrap fd-cf">
                        <?php echo FD::bbcode()->editor('content', $discussion->content, array('files' => $files, 'uid' => $project->id, 'type' => SOCIAL_TYPE_PROJECT, 'controllerName' => 'projects')); ?>
                    </div>
                </div>
