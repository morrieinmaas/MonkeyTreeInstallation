...
<li class="reply-item<?php echo $answer && $answer->id == $reply->id ? ' is-answer-item' : ''; ?>" data-reply-item data-id="<?php echo $reply->id; ?>">
    ...
    <?php if ($project->isAdmin() || $this->my->isSiteAdmin() || $reply->created_by == $this->my->id || $question->created_by == $this->my->id) { ?>
    <div class="pull-right btn-group">
        ...
        <ul class="dropdown-menu dropdown-menu-user messageDropDown">
            <?php if (($question->created_by == $this->my->id || $this->my->isSiteAdmin() || $project->isAdmin()) && (!$answer || ($answer && $reply->id != $answer->id))) { ?>
            <li>
                <a href="javascript:void(0);" data-reply-accept-answer><?php echo JText::_('APP_PROJECT_DISCUSSIONS_ACCEPT_ANSWER'); ?></a>
            </li>
            <li class="divider"></li>
            <?php } ?>

            <?php if ($reply->created_by == $this->my->id || $this->my->isSiteAdmin() || $project->isAdmin()) { ?>
            <li>
                <a href="javascript:void(0);" data-reply-edit><?php echo JText::_('APP_PROJECT_DISCUSSIONS_EDIT_REPLY'); ?></a>
            </li>
            <li>
                <a href="javascript:void(0);" data-reply-delete><?php echo JText::_('APP_PROJECT_DISCUSSIONS_DELETE_REPLY'); ?></a>
            </li>
            <?php } ?>
        </ul>
    </div>
    ...
    <div class="media">
        ...
        <div class="media-body">
            ...
            <div class="reply-author">
                ...
                <span class="label label-success label-answer-item"><i class="fa fa-support "></i> <?php echo JText::_('APP_PROJECT_DISCUSSIONS_ACCEPTED_ANSWER'); ?></span>
            </div>
            ...
            <form data-reply-form class="reply-form reply-content-edit">
                ...
                <?php echo FD::bbcode()->editor('reply_content', $reply->content, array('files' => $files, 'uid' => $project->id, 'type' => SOCIAL_TYPE_PROJECT, 'controllerName' => 'projects'), array('data-reply-content' => '')); ?>
