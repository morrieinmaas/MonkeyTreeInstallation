...
class DiscussionsViewItem extends SocialAppsView
{
    ...
    public function display($uid = null, $docType = null)
    {
        ...
        $url         = FRoute::apps(array('layout' => 'canvas', 'customView' => 'item', 'uid' => $project->getAlias(), 'type' => SOCIAL_TYPE_PROJECT, 'id' => $this->app->getAlias(), 'discussionId' => $discussion->id), false);
